...
const uint8_t font_p[289][9] = { // proportional font
        ...
        /*0192*/ { 0x04, 0x04, 0x02, 0x00, 0x0f, 0x08, 0x0f, 0x08, 0x0f },   // 0xd080  Ѐ    CYRILLIC CAPITAL LETTER IE WITH GRAVE
        /*0193*/ { 0x05, 0x0A, 0x00, 0x1F, 0x10, 0x1E, 0x10, 0x1F, 0x00 },   // 0xd081  Ё    CYRILLIC CAPITAL LETTER IO
        /*0194*/ { 0x07, 0x7C, 0x10, 0x16, 0x19, 0x11, 0x11, 0x16, 0x00 },   // 0xd082  Ђ    CYRILLIC CAPITAL LETTER DJE
        /*0195*/ { 0x04, 0x02, 0x00, 0x0F, 0x08, 0x08, 0x08, 0x08, 0x00 },   // 0xd083  Ѓ    CYRILLIC CAPITAL LETTER GJE
        /*0196*/ { 0x05, 0x0E, 0x11, 0x10, 0x1C, 0x10, 0x11, 0x0E, 0x00 },   // 0xd084  Є    CYRILLIC CAPITAL LETTER UKRAINIAN IE
        /*0197*/ { 0x05, 0x0E, 0x11, 0x10, 0x0E, 0x01, 0x11, 0x0E, 0x00 },   // 0xd085  Ѕ    CYRILLIC CAPITAL LETTER DZE
        /*0198*/ { 0x03, 0x07, 0x02, 0x02, 0x02, 0x02, 0x02, 0x07, 0x00 },   // 0xd086  І    CYRILLIC CAPITAL LETTER BYELORUSSION-UKRAINIAN I
        /*0199*/ { 0x03, 0x05, 0x00, 0x02, 0x02, 0x02, 0x02, 0x02, 0x00 },   // 0xd087  Ї    CYRILLIC CAPITAL LETTER YI
        /*0200*/ { 0x04, 0x0F, 0x02, 0x02, 0x02, 0x02, 0x12, 0x0C, 0x00 },   // 0xd088  Ј    CYRILLIC CAPITAL LETTER JE
        /*0201*/ { 0x07, 0x38, 0x28, 0x28, 0x2E, 0x29, 0x29, 0x4E, 0x00 },   // 0xd089  Љ    CYRILLIC CAPITAL LETTER LJE
        /*0202*/ { 0x06, 0x28, 0x28, 0x28, 0x3E, 0x29, 0x29, 0x2E, 0x00 },   // 0xd08a  Њ    CYRILLIC CAPITAL LETTER NJE
        /*0203*/ { 0x06, 0x38, 0x10, 0x16, 0x19, 0x11, 0x11, 0x11, 0x00 },   // 0xd08b  Ћ    CYRILLIC CAPITAL LETTER TSHE
        /*0204*/ { 0x06, 0x29, 0x22, 0x24, 0x38, 0x24, 0x22, 0x21, 0x00 },   // 0xd08c  Ќ    CYRILLIC CAPITAL LETTER KJE
        /*0205*/ { 0x05, 0x08, 0x04, 0x11, 0x13, 0x15, 0x19, 0x11, 0x00 },   // 0xd08d  Ѝ    CYRILLIC CAPITAL LETTER I WITH GRAVE
        /*0206*/ { 0x05, 0x15, 0x15, 0x11, 0x09, 0x07, 0x01, 0x02, 0x1C },   // 0xd08e  Ў    CYRILLIC CAPITAL LETTER SHORT U
        /*0207*/ { 0x05, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x1F, 0x04 },   // 0xd08f  Џ    CYRILLIC CAPITAL LETTER DZHE
        /*0208*/ { 0x05, 0x04, 0x0a, 0x11, 0x11, 0x1F, 0x11, 0x11, 0x00 },   // 0xd090  А    CYRILLIC CAPITAL LETTER A
        /*0209*/ { 0x05, 0x1F, 0x10, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00 },   // 0xd091  Б    CYRILLIC CAPITAL LETTER BE
        /*0210*/ { 0x05, 0x1E, 0x11, 0x11, 0x1E, 0x11, 0x11, 0x1E, 0x00 },   // 0xd092  В    CYRILLIC CAPITAL LETTER VE
        /*0211*/ { 0x05, 0x1F, 0x11, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 },   // 0xd093  Г    CYRILLIC CAPITAL LETTER GHE
        /*0212*/ { 0x06, 0x0C, 0x12, 0x12, 0x12, 0x12, 0x12, 0x3F, 0x21 },   // 0xd094  Д    CYRILLIC CAPITAL LETTER DE
        /*0213*/ { 0x05, 0x1F, 0x10, 0x10, 0x1E, 0x10, 0x10, 0x1F, 0x00 },   // 0xd095  Е    CYRILLIC CAPITAL LETTER IE
        /*0214*/ { 0x05, 0x15, 0x15, 0x15, 0x0E, 0x15, 0x15, 0x15, 0x00 },   // 0xd096  Ж    CYRILLIC CAPITAL LETTER ZHE
        /*0215*/ { 0x05, 0x1E, 0x01, 0x01, 0x0E, 0x01, 0x01, 0x1E, 0x00 },   // 0xd097  З    CYRILLIC CAPITAL LETTER ZE
        /*0216*/ { 0x05, 0x11, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00 },   // 0xd098  И    CYRILLIC CAPITAL LETTER I
        /*0217*/ { 0x05, 0x15, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00 },   // 0xd099  Й    CYRILLIC CAPITAL LETTER SHORT I
        /*0218*/ { 0x05, 0x11, 0x12, 0x14, 0x18, 0x14, 0x12, 0x11, 0x00 },   // 0xd09a  К    CYRILLIC CAPITAL LETTER KA
        /*0219*/ { 0x05, 0x07, 0x09, 0x09, 0x09, 0x09, 0x09, 0x11, 0x00 },   // 0xd09b  Л    CYRILLIC CAPITAL LETTER EL
        /*0220*/ { 0x05, 0x11, 0x1B, 0x15, 0x15, 0x11, 0x11, 0x11, 0x00 },   // 0xd09c  М    CYRILLIC CAPITAL LETTER EM
        /*0221*/ { 0x05, 0x11, 0x11, 0x11, 0x1F, 0x11, 0x11, 0x11, 0x00 },   // 0xd09d  Н    CYRILLIC CAPITAL LETTER EN
        /*0222*/ { 0x05, 0x0E, 0x11, 0x11, 0x11, 0x11, 0x11, 0x0E, 0x00 },   // 0xd09e  О    CYRILLIC CAPITAL LETTER O
        /*0223*/ { 0x05, 0x1F, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x00 },   // 0xd09f  П    CYRILLIC CAPITAL LETTER PE
        /*0224*/ { 0x05, 0x1E, 0x11, 0x11, 0x1E, 0x10, 0x10, 0x10, 0x00 },   // 0xd0a0  Р    CYRILLIC CAPITAL LETTER ER
        /*0225*/ { 0x05, 0x0E, 0x11, 0x10, 0x10, 0x10, 0x11, 0x0E, 0x00 },   // 0xd0a1  С    CYRILLIC CAPITAL LETTER ES
        /*0226*/ { 0x05, 0x1F, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x00 },   // 0xd0a2  Т    CYRILLIC CAPITAL LETTER TE
        /*0227*/ { 0x05, 0x11, 0x11, 0x11, 0x0F, 0x01, 0x11, 0x0E, 0x00 },   // 0xd0a3  У    CYRILLIC CAPITAL LETTER U
        /*0228*/ { 0x07, 0x08, 0x3E, 0x49, 0x49, 0x49, 0x3E, 0x08, 0x00 },   // 0xd0a4  Ф    CYRILLIC CAPITAL LETTER EF
        /*0229*/ { 0x05, 0x11, 0x11, 0x0A, 0x04, 0x0A, 0x11, 0x11, 0x00 },   // 0xd0a5  Х    CYRILLIC CAPITAL LETTER HA
        /*0230*/ { 0x06, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x3F, 0x01 },   // 0xd0a6  Ц    CYRILLIC CAPITAL LETTER TSE
        /*0231*/ { 0x05, 0x11, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x01, 0x00 },   // 0xd0a7  Ч    CYRILLIC CAPITAL LETTER CHE
        /*0232*/ { 0x05, 0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x1F, 0x00 },   // 0xd0a8  Ш    CYRILLIC CAPITAL LETTER SHA
        /*0233*/ { 0x06, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x3F, 0x01 },   // 0xd0a9  Щ    CYRILLIC CAPITAL LETTER SHCHA
        /*0234*/ { 0x07, 0x70, 0x10, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00 },   // 0xd0aa  Ъ    CYRILLIC CAPITAL LETTER HARD SIGN
        /*0235*/ { 0x07, 0x41, 0x41, 0x41, 0x79, 0x45, 0x45, 0x79, 0x00 },   // 0xd0ab  Ы    CYRILLIC CAPITAL LETTER YERU
        /*0236*/ { 0x05, 0x10, 0x10, 0x10, 0x1E, 0x11, 0x11, 0x1E, 0x00 },   // 0xd0ac  Ь    CYRILLIC CAPITAL LETTER SOFT SIGN
        /*0237*/ { 0x04, 0x0E, 0x01, 0x01, 0x07, 0x01, 0x01, 0x0E, 0x00 },   // 0xd0ad  Э    CYRILLIC CAPITAL LETTER E
        /*0238*/ { 0x06, 0x26, 0x29, 0x29, 0x39, 0x29, 0x29, 0x26, 0x00 },   // 0xd0ae  Ю    CYRILLIC CAPITAL LETTER YU
        /*0239*/ { 0x05, 0x0F, 0x11, 0x11, 0x0F, 0x05, 0x09, 0x11, 0x00 },   // 0xd0af  Я    CYRILLIC CAPITAL LETTER YA
        /*0240*/ { 0x05, 0x00, 0x00, 0x0E, 0x01, 0x0F, 0x11, 0x0F, 0x00 },   // 0xd0b0  а    CYRILLIC SMALL LETTER A
        /*0241*/ { 0x05, 0x03, 0x0C, 0x10, 0x1E, 0x11, 0x11, 0x0E, 0x00 },   // 0xd0b1  б    CYRILLIC SMALL LETTER BE
        /*0242*/ { 0x05, 0x00, 0x00, 0x1E, 0x11, 0x1E, 0x11, 0x1E, 0x00 },   // 0xd0b2  в    CYRILLIC SMALL LETTER VE
        /*0243*/ { 0x04, 0x00, 0x00, 0x0F, 0x09, 0x08, 0x08, 0x08, 0x00 },   // 0xd0b3  г    CYRILLIC SMALL LETTER GHE
        /*0244*/ { 0x06, 0x00, 0x00, 0x0C, 0x12, 0x12, 0x12, 0x3F, 0x21 },   // 0xd0b4  д    CYRILLIC SMALL LETTER DE
        /*0245*/ { 0x05, 0x00, 0x00, 0x0E, 0x11, 0x1F, 0x10, 0x0E, 0x00 },   // 0xd0b5  е    CYRILLIC SMALL LETTER IE
        /*0246*/ { 0x05, 0x00, 0x00, 0x15, 0x15, 0x0E, 0x15, 0x15, 0x00 },   // 0xd0b6  ж    CYRILLIC SMALL LETTER ZHE
        /*0247*/ { 0x05, 0x00, 0x00, 0x1E, 0x01, 0x0E, 0x01, 0x1E, 0x00 },   // 0xd0b7  з    CYRILLIC SMALL LETTER ZE
        /*0248*/ { 0x05, 0x00, 0x00, 0x11, 0x13, 0x15, 0x19, 0x11, 0x00 },   // 0xd0b8  и    CYRILLIC SMALL LETTER I
        /*0249*/ { 0x05, 0x0e, 0x00, 0x11, 0x13, 0x15, 0x19, 0x11, 0x00 },   // 0xd0b9  й    CYRILLIC SMALL LETTER SHORT I
        /*0250*/ { 0x05, 0x00, 0x00, 0x11, 0x12, 0x1C, 0x12, 0x11, 0x00 },   // 0xd0ba  к    CYRILLIC SMALL LETTER KA
        /*0251*/ { 0x05, 0x00, 0x00, 0x07, 0x09, 0x09, 0x09, 0x11, 0x00 },   // 0xd0bb  л    CYRILLIC SMALL LETTER EL
        /*0252*/ { 0x05, 0x00, 0x00, 0x11, 0x1B, 0x15, 0x11, 0x11, 0x00 },   // 0xd0bc  м    CYRILLIC SMALL LETTER EM
        /*0253*/ { 0x05, 0x00, 0x00, 0x11, 0x11, 0x1F, 0x11, 0x11, 0x00 },   // 0xd0bd  н    CYRILLIC SMALL LETTER EN
        /*0254*/ { 0x05, 0x00, 0x00, 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x00 },   // 0xd0be  о    CYRILLIC SMALL LETTER O
        /*0255*/ { 0x05, 0x00, 0x00, 0x1F, 0x11, 0x11, 0x11, 0x11, 0x00 },   // 0xd0bf  п    CYRILLIC SMALL LETTER PE
        /*0256*/ { 0x05, 0x00, 0x00, 0x1E, 0x11, 0x11, 0x1E, 0x10, 0x10 },   // 0xd180  р    CYRILLIC SMALL LETTER ER
        /*0257*/ { 0x04, 0x00, 0x00, 0x07, 0x08, 0x08, 0x08, 0x07, 0x00 },   // 0xd181  с    CYRILLIC SMALL LETTER ES
        /*0258*/ { 0x05, 0x00, 0x00, 0x1F, 0x04, 0x04, 0x04, 0x04, 0x00 },   // 0xd182  т    CYRILLIC SMALL LETTER TE
        /*0259*/ { 0x05, 0x00, 0x00, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x0E },   // 0xd183  у    CYRILLIC SMALL LETTER U
        /*0260*/ { 0x07, 0x00, 0x00, 0x08, 0x3E, 0x49, 0x3E, 0x08, 0x08 },   // 0xd184  ф    CYRILLIC SMALL LETTER EF
        /*0261*/ { 0x05, 0x00, 0x00, 0x11, 0x0A, 0x04, 0x0A, 0x11, 0x00 },   // 0xd185  х    CYRILLIC SMALL LETTER HA
        /*0262*/ { 0x05, 0x00, 0x00, 0x12, 0x12, 0x12, 0x12, 0x1F, 0x01 },   // 0xd186  ц    CYRILLIC SMALL LETTER TSE
        /*0263*/ { 0x05, 0x00, 0x00, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x00 },   // 0xd187  ч    CYRILLIC SMALL LETTER CHE
        /*0264*/ { 0x05, 0x00, 0x00, 0x15, 0x15, 0x15, 0x15, 0x1F, 0x00 },   // 0xd188  ш    CYRILLIC SMALL LETTER CHA
        /*0265*/ { 0x06, 0x00, 0x00, 0x2A, 0x2A, 0x2A, 0x2A, 0x3F, 0x01 },   // 0xd189  щ    CYRILLIC SMALL LETTER SHCHA
        /*0266*/ { 0x05, 0x00, 0x00, 0x18, 0x08, 0x0E, 0x09, 0x0E, 0x00 },   // 0xd18a  ъ    CYRILLIC SMALL LETTER HARD SIGN
        /*0267*/ { 0x06, 0x00, 0x00, 0x21, 0x21, 0x39, 0x25, 0x39, 0x00 },   // 0xd18b  ы    CYRILLIC SMALL LETTER YERU
        /*0268*/ { 0x04, 0x00, 0x00, 0x08, 0x08, 0x0E, 0x09, 0x0E, 0x00 },   // 0xd18c  ь    CYRILLIC SMALL LETTER SOFT SIGN
        /*0269*/ { 0x04, 0x00, 0x00, 0x0E, 0x01, 0x07, 0x01, 0x0E, 0x00 },   // 0xd18d  э    CYRILLIC SMALL LETTER E
        /*0270*/ { 0x06, 0x00, 0x00, 0x26, 0x29, 0x39, 0x29, 0x26, 0x00 },   // 0xd18e  ю    CYRILLIC SMALL LETTER YU
        /*0271*/ { 0x04, 0x00, 0x00, 0x07, 0x09, 0x07, 0x05, 0x09, 0x00 },   // 0xd18f  я    CYRILLIC SMALL LETTER YA
        /*0272*/ { 0x05, 0x0A, 0x00, 0x0E, 0x11, 0x1F, 0x10, 0x0E, 0x00 },   // 0xd191  ё    CYRILLIC SMALL LETTER IO
        /*0273*/ { 0x06, 0x10, 0x38, 0x10, 0x16, 0x19, 0x11, 0x11, 0x02 },   // 0xd192  ђ    CYRILLIC SMALL LETTER DJE
        /*0274*/ { 0x03, 0x00, 0x02, 0x00, 0x07, 0x04, 0x04, 0x04, 0x00 },   // 0xd193  ѓ    CYRILLIC SMALL LETTER GJE
        /*0275*/ { 0x04, 0x00, 0x00, 0x07, 0x08, 0x0E, 0x08, 0x07, 0x00 },   // 0xd194  є    CYRILLIC SMALL LETTER UKRAINIAN IE
        /*0276*/ { 0x04, 0x00, 0x00, 0x07, 0x08, 0x06, 0x01, 0x0E, 0x00 },   // 0xd195  ѕ    CYRILLIC SMALL LETTER DZE
        /*0277*/ { 0x03, 0x00, 0x02, 0x00, 0x06, 0x02, 0x02, 0x07, 0x00 },   // 0xd196  і    CYRILLIC SMALL LETTER BYELORUSSION-UKRAINIAN I
        /*0278*/ { 0x03, 0x00, 0x05, 0x00, 0x02, 0x02, 0x02, 0x02, 0x00 },   // 0xd197  ї    CYRILLIC SMALL LETTER YI
        /*0279*/ { 0x04, 0x00, 0x01, 0x00, 0x03, 0x01, 0x01, 0x09, 0x06 },   // 0xd198  ј    CYRILLIC SMALL LETTER JE
        /*0280*/ { 0x07, 0x00, 0x00, 0x38, 0x28, 0x2E, 0x29, 0x4E, 0x00 },   // 0xd199  љ    CYRILLIC SMALL LETTER LJE
        /*0281*/ { 0x06, 0x00, 0x28, 0x28, 0x28, 0x3E, 0x29, 0x2E, 0x00 },   // 0xd19a  њ    CYRILLIC SMALL LETTER NJE
        /*0282*/ { 0x06, 0x10, 0x38, 0x10, 0x16, 0x19, 0x11, 0x11, 0x00 },   // 0xd19b  ћ    CYRILLIC SMALL LETTER TSHE
        /*0283*/ { 0x04, 0x0A, 0x08, 0x09, 0x0A, 0x0C, 0x0A, 0x09, 0x00 },   // 0xd19c  ќ    CYRILLIC SMALL LETTER KJE
        /*0284*/ { 0x04, 0x04, 0x02, 0x00, 0x09, 0x0b, 0x0d, 0x09, 0x00 },   // 0xd19d  ѝ    CYRILLIC SMALL LETTER I WITH GRAVE
        /*0285*/ { 0x05, 0x04, 0x04, 0x11, 0x11, 0x0F, 0x01, 0x11, 0x0E },   // 0xd19e  ў    CYRILLIC SMALL LETTER SHORT U
        /*0286*/ { 0x05, 0x00, 0x00, 0x11, 0x11, 0x11, 0x11, 0x1F, 0x04 },   // 0xd19f  џ    CYRILLIC SMALL LETTER DZHE
        /*0287*/ { 0x04, 0x01, 0x0F, 0x08, 0x08, 0x08, 0x08, 0x08, 0x00 },   // 0xd290  Ґ    CYRILLIC CAPITAL LETTER GHE WITH UPTURN
        /*0288*/ { 0x04, 0x00, 0x01, 0x0F, 0x08, 0x08, 0x08, 0x08, 0x00 },   // 0xd291  ґ    CYRILLIC SMALL LETTER GHE WITH UPTURN
};
...
uint8_t char2Arr_p(uint16_t ch, int PosX) { //characters into arr, proportional font
    ...
    if (ch <= 288){                   //character found in font?
...
uint16_t scrolltext(int16_t posX, String txt)
{
    ...
    while((txt[i]!=0)&&(j<256)){
        ...
        if(txt[i]==0xCE){   // greek section
            if((txt[i+1]>=0x86)&&(txt[i+1]<=0xBF)){ /* not implemented yet */ }
        }
        if(txt[i]==0xCF){   // greek section
            if((txt[i+1]>=0x80)&&(txt[i+1]<=0xBF)){ /* not implemented yet */ }
        }
        if(txt[i]==0xD0){   // cyrillic section
            if((txt[i+1]>=0x80)&&(txt[i+1]<=0xBF)){_chbuf[j]=txt[i+1]+0x40; k=true; i+=2; j++;}
        }
        if(txt[i]==0xD1){   // cyrillic section
            if((txt[i+1]>=0x80)&&(txt[i+1]<=0x9F)){_chbuf[j]=txt[i+1]+0x80; k=true; i+=2; j++;}
        }
        if(k==false){
